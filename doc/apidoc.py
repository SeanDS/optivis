...
"""
    ...
    MODIFIED version of sphinx.apidoc to implement different default options
    with arguments.
...
def format_directive(module, package=None):
    ...
    for option in OPTIONS:
        if OPTION_ARGS.has_key(option):
            # option arguments specified
            option_args = ' ' + OPTION_ARGS[option]
        else:
            option_args = ''
