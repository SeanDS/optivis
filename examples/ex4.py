...
scene.link(outputNode=bs1.getOutputNode('frA'), inputNode=m3.getInputNode('fr'), length=70)
scene.link(outputNode=bs1.getOutputNode('bkA'), inputNode=m4.getInputNode('fr'), length=50, pattern=[1, 2])
scene.link(outputNode=m2.getOutputNode('fr'), inputNode=m3.getInputNode('fr'))
